...
const items = [
  {
    ...
    title:
      "CONTENT MARKETING LÀ GÌ? Ý TƯỞNG VIẾT CONTENT MARKETING THU HÚT KHÁCH HÀNG",
    content:
  ...
  },
  {
    ...
    content:
      "Social Media là nền tảng mang đến nhiều tiềm năng phát triển cho doanh nghiệp. Khi biết cách tối ưu hình ảnh chuẩn trên Social Media sẽ mang đến ấn tượng tốt và sự chuyên nghiệp đến với khách hàng. Và dưới đây là tổng hợp kích thước chuẩn hình ảnh trên các kênh Social Media, bạn nhớ lưu lại và áp dụng nhé!",
  ...
  },
  {
    ...
    content:
      "Tiktok là sân chơi mới có số lượng người truy cập nhiều nhất hiện nay, người dùng có thể dễ dàng tham gia chia sẻ đa dạng nội dung thông qua dạng video ngắn. Nếu bạn chưa biết cách làm video tiktok, hãy tham khảo ngay bài chia sẻ dưới đây của Staspi.",
  ...
  const content = topic.map((item, index) => {
    if (index >= start && index < end) {
      ...
      html +=
        ...
        ">";
      html +=
        '<div class = "title-item">' + "<h4>" + item.title + "</h4>" + "</div>";
